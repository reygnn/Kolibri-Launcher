 ...
 *
 * State is detected from visible views + awaitUntil (see BasePage); no
 * production test-hooks. Seeding (consent, home layout) belongs in the test's
 * @Before BEFORE [start], so the facade stays stateless.
 */
