...
class FakePreferencesRepository(
    ...
    private val rotationLockedState = MutableStateFlow(rotationLocked)
    ...
    override fun rotationLocked(): Flow<Boolean> = rotationLockedState
    override suspend fun setRotationLocked(enabled: Boolean) { rotationLockedState.value = enabled }
