...
class InstalledAppsStateRepositoryImplTest {

    @get:Rule
    val timberRule = TimberRule()

    private lateinit var stateManager: InstalledAppsStateRepositoryImpl
    ...
    @Before
    fun setup() {
        stateManager = InstalledAppsStateRepositoryImpl()
    }
