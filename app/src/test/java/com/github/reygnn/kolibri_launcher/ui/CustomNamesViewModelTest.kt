...
class CustomNamesViewModelTest {
    ...
    @Before
    fun setUp() {
        // Konvention: KEIN eigener StandardTestDispatcher, KEIN Dispatchers.setMain.
        // MainDispatcherRule erledigt das mit seinem testDispatcher.
    ...
    // KEIN @After mit Dispatchers.resetMain() — MainDispatcherRule räumt das selbst auf.
