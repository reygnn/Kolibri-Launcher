...
/**
 * Contract-Test-Ausführung gegen die echte Produktionsklasse [WallpaperManager].
 *
 * Setup-Details:
 ...
 *   `WallpaperManagerTest` nutzt aus demselben Grund Robolectric.
 */
@RunWith(RobolectricTestRunner::class)
class WallpaperManagerContractTest : WallpaperRepositoryContract() {
    ...
    override fun createRepository(): WallpaperRepository {
        ...
        return WallpaperManager(fakeDataStore, fileManager)
    }
}
