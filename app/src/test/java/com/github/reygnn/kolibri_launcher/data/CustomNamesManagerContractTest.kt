...
/**
 * Contract-Test-Ausführung gegen die echte Produktionsklasse [CustomNamesManager].
 *
 * Setup-Details:
 ...
 *   weil dort `InstalledAppsManager` als Subscriber permanent zuhört und
 ...
 */
class CustomNamesManagerContractTest : CustomNamesRepositoryContract() {
    ...
    override fun createRepository(): CustomNamesRepository {
        ...
        return CustomNamesManager(fakeDataStore, appsUpdateTrigger, mockContext)
    }
}
