 ...
 * - `InstalledAppsManager` filters its master list by checking against this set
 ...
 * 4. `InstalledAppsManager` observes Flow and rebuilds filtered app list
 ...
 *
 * @see CustomNamesManager for an example where event-based triggers are more appropriate
 */
@Singleton
