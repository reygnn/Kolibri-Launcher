 ...
 * sitting between `InstalledAppsRepositoryImpl` (data source) and the UI layer (consumers).
 ...
 * **Data Flow Position:**
 * ```
 * InstalledAppsRepositoryImpl (loads) → InstalledAppsStateRepositoryImpl (holds) → UI (observes)
 * ```
 *
 ...
 *
 * @see InstalledAppsRepositoryImpl for the data loading and processing logic
 */
@Singleton
