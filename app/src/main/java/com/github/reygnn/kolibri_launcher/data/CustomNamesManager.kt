 ...
 *
 * @see HiddenAppsManager for an example where a Flow is the correct pattern.
 */
 ...
 *
 * @see HiddenAppsManager for an example where Flow-based state exposure is correct
 */
@Singleton
class CustomNamesManager @Inject constructor(
