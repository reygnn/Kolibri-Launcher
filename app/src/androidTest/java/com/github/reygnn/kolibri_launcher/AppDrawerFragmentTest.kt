...
import com.github.reygnn.kolibri_launcher.ui.AppDrawerFragment
...
class AppDrawerFragmentTest : BaseAndroidTest() {
    ...
    fun favoriteLimit_preventsAddingMoreFavorites() = testCoroutineRule.runTestAndLaunchUI(TestCoroutineRule.Mode.SAFE) {
        ...
        fakeFavoriteAppsUseCase.favoriteAppsState.value = UiState.Success(FavoriteAppsResult(apps = maxFavoriteApps, isFallback = false))
